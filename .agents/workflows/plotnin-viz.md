---
description: Use this skill for ALL data visualization tasks using the plotnine library (Python's ggplot2).   Triggers: "plotnine chart", "plotnine world map", "ggplot2 python", "geom_map", "geom_point",   "geom_col", "geom_bar", "geom_line", "geom_smooth", "line
---
